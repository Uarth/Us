...
def download_table(table_name, curs):
...
def Matching(userid):
    ...
    user = download_table('user', curs)
    user = user.drop(index=0)
    Q1 = download_table('question1', curs)
    Q1 = Q1.drop(index=0)
    Q2 = download_table('question2', curs)
    Q3 = download_table('question3', curs)
    hobby = download_table('featureselect', curs)
